...
<div class="place-self-center max-w-prose h-full">
  ...
  <p
    class="bg-gray-200 font-mono flex justify-between py-1 rounded-lg text-base px-1 leading-7 lg:leading-8 xl:text-xl xl:px-2 xl:my-3 xl:leading-8 2xl:text-[1.4rem] 2xl:my-4 fhd:text-3xl fhd:py-2 fhd:my-6 fhd:rounded-xl"
  >
    {baseURL + matchID}
    <button
